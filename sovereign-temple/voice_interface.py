...
class VoiceChatSession:
    ...
    def __init__(self, voice_interface: VoiceInterface, mcp_endpoint: str = "http://localhost:3100/mcp"):
    ...
    return [
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "format": {"type": "string", "enum": ["wav", "mp3", "m4a"], "default": "wav"}
                },
        ...
        },
        {
            ...
            "inputSchema": {
                ...
                "properties": {
                    ...
                    "voice": {"type": "string", "description": "Voice name (rachel, adam, antoni, elli, etc.)"}
                },
                "required": ["text"]
            }
        },
...
if __name__ == "__main__":
    ...
    async def test():
        ...
        audio = await vi.text_to_speech("Hello, I am Sovereign. How can I assist you today?")
